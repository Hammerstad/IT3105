...
public class CardUtilities {
	...
	/**
	 * Returns the classification of a hand. This is a 6-element long array.
	 * The first element in the array is the strength of the hand, 9 for straight flush,
	 * 8 for four of a kind, 7 for full house etc. The rest of the elements is the cards
	 * in descending order, padded with 0s if there are less than 5 cards.
	 */
	...
	/**
	 * Checks if a hand is a full house. Returns an array with strength followed by
	 * the hand if the hand is a full house. Returns null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a four of a kind. Returns an array with strength followed by
	 * the hand if the hand is a four of a kind. Returns null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a three of a kind. Returns an array with strength followed by
	 * the hand if the hand is a three of a kind. Returns null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a two pairs. Returns an array with strength followed by
	 * the hand if the hand is a two pairs. Returns null otherwise.
	 */
	...
	/**
	 * Checks the highest card. Returns an array with strength followed by
	 * the hand sorted descending.
	 */
