...
/**
 * This class handles card classification to be used in hand strength calculation.
 */
public class CardUtilities {

	/**
	 * Returns the classification of a hand. This is a 6-element long array. The first element in the array is the strength of the hand, 9
	 * for straight flush, 8 for four of a kind, 7 for full house etc. The rest of the elements is the cards in descending order, padded
	 * with 0s if there are less than 5 cards.
	 */
	...
	/**
	 * This function takes in a int[] and makes sure it is 6 elements long. If unpadded is less than 6 elements, it's padded with 0s.
	 */
	...
	/**
	 * Checks if a hand is a straight flush. Returns an array with strength followed by the hand if the hand is a straight flush. Returns
	 * null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a straight. Returns an array with strength followed by the hand if the hand is a straight. Returns null
	 * otherwise.
	 */
	...
	/**
	 * Checks if a hand is a flush. Returns an array with strength followed by the hand if the hand is a flush. Returns null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a full house. Returns an array with strength followed by the hand if the hand is a full house. Returns null
	 * otherwise.
	 */
	...
	/**
	 * Checks if a hand is a four of a kind. Returns an array with strength followed by the hand if the hand is a four of a kind. Returns
	 * null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a three of a kind. Returns an array with strength followed by the hand if the hand is a three of a kind. Returns
	 * null otherwise.
	 */
	...
	/**
	 * Checks if a hand is a two pairs. Returns an array with strength followed by the hand if the hand is a two pairs. Returns null
	 * otherwise.
	 */
	...
	/**
	 * Checks if a hand is a pair. Returns an array with strength followed by the hand if the hand is a pair. Returns null otherwise.
	 */
	...
	/**
	 * Checks the highest card. Returns an array with strength followed by the hand sorted descending.
	 */
